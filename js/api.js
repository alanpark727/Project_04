$(document).ready(function(){
    ...
    let search2;
    search2 = ["해리포터와 마법사의 돌", "듄 1권", "세이노의 가르침", "프로젝트 헤일메리", "아주 작은 습관의 힘", "데일 카네기 인간관계론", "부의 추월차선", "타이탄의 도구들", "눈물을 마시는 1", "살인자의 쇼핑몰", "트렌드 코리아 2024", "더 마인드", "레버리지", "나다움으로 시작하는", "애거서 크리스티", "나는 메트로폴리탄", "바다가 들리는 편의점", "역행자"];
    ...
    let search6;
    search6 = ["아메리칸 프로메테우스", "오펜하이머 각본집", "플라워 문", "가여운 것들", "호빗", "파워 오브 도그"];
    ...
    let search7;
    search7 = ["부의 추월차선", "메리골드 마음", "과학이 필요한 시간", "세상의 마지막 기차역", "언스크립티드", "내가 행복한 이유", "그 문장을 읽고 또 읽었다", "나는 메트로폴리탄 미술관", "부의 추월차선 위대한 탈출", "파우스트" ];
    ...
    let search9;
    search9 = ["직장 상사 악령 퇴치부", "사라진 것들", "오류가 발생했습니다", "살인자의 쇼핑몰", "홍학의 자리", "프로젝트 헤일메리", "듄 1권", "구의 증명", "호빗", "파과", "아주 희미한 빛으로도", "도시와 그 불확실한 벽"];
    ...
    let search13;
    search13 = ["도둑맞은 집중력", "지루하면 죽는다", "마흔에 읽는 쇼펜하우어", "도파민네이션", "사피엔스", "빅터 프랭클의 죽음의 수용소에서", "사랑의 기술", "지적 대화를 위한 넓고 얕은 지식1", "정의란 무엇인가", "제정신이라는 착각", "가짜 노동", "공정하다는 착각"];
